        ...
        <div class="dropdown">
            <button class="btn dropdown-toggle btn-outline-warning text-dark" type="button" id="dropdownMenu3" data-toggle="dropdown"
                ...
                @auth("web")
                    <div class="d-inline-block">
                        <span class="d-inline-block"> <i class="bi bi-person-bounding-box btn-outline-info"></i> </span>
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenu3">
                ...
                @auth("web")
                    ...
                    <a class="dropdown-item" href="{{route('profile')}}"> <i class="bi bi-person-circle btn-outline-info"></i> Профиль</a>
                    <a class="dropdown-item" href="{{ route("logout") }}"> <i class="bi bi-box-arrow-right btn-outline-info"></i> Выйти</a>
                @endauth
