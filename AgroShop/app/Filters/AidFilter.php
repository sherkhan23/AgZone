...
//        $culture = Aids::whereHas('aids_utilization_norm_id', function($q){
//            $q->where('culture_id', 'value');
//        })->get();

        return $this->builder->where('aids.culture_id', $aid_id );
    }

    public function hazardFilter($aid_id){
        return $this->builder->where('aids.aids_utilization_norms.hazard_id', $aid_id );
    }
